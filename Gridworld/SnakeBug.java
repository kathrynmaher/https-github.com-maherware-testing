...
public class SnakeBug extends Bug
{
	...
	{
		Location newLocation = getRandomEmptyLocation();
      Flower newFlower = new Flower();
      Grid<Actor> g = getGrid();
      newFlower.putSelfInGrid(g, newLocation);
	}
	...
	{
		Location element = locations.remove(locations.size()-1);
      Grid<Actor> g = getGrid();
      Actor r = g.get(element);
