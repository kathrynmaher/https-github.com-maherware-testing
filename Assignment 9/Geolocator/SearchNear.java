...
//       Scanner input = new Scanner(new File("places-combined.txt"));
        ArrayList<PlaceInformation> data = readFile(input);

        Scanner console = new Scanner(System.in);
        System.out.print("target? ");
        String name = console.nextLine();
        GeoLocation geoLoc = GeoLocator.find(name);
        PlaceInformation placeInfo = new PlaceInformation(name, "", "", geoLoc.getLatitude(), geoLoc.getLongitude());
        showMatches(data, console, placeInfo);
    }
    ...
    public static void showMatches(ArrayList<PlaceInformation> data,
                                   Scanner console, PlaceInformation target) {
